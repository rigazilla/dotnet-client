namespace Infinispan.HotRod
{
    ...
    public class RemoteCacheManagerAdmin
    {
        ...
        {
            remoteCacheManagerAdmin.createCache(name, model, "@@cache@create");
        ...
        {
            remoteCacheManagerAdmin.createCache(name, model, "@@cache@getorcreate");
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <param name="conf"></param>
        /// <returns></returns>
        public IRemoteCache<K, V> GetOrGetCacheWithXml<K, V>(string name, string conf)
        {
