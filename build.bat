...
cmake -G "%full_generator%" -DHOTRODCPP32_HOME=%HOTRODCPP32_HOME% -DHOTRODCPP64_HOME=%HOTRODCPP64_HOME%  -DPROTOBUF_INCLUDE_DIR=%PROTOBUF_INCLUDE_DIR% %~4 -DPROTOBUF_PROTOC_EXECUTABLE=%PROTOBUF_PROTOC_EXECUTABLE% -DGOOGLE_PROTOBUF_NUPKG=%GOOGLE_PROTOBUF_NUPKG% ..
